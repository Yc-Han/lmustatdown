...
division: 'Faculty 16: Informatik, Mathematik und Statistik'
...
# This will automatically install the {remotes} package and {lmustatdown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {lmustatdown}': True
  
# Remove the hashtag to specify which version of output you would like.
# Can only choose one at a time.
output:
  lmustatdown::thesis_pdf: default 
#  lmustatdown::thesis_gitbook: default         
#  lmustatdown::thesis_word: default
#  lmustatdown::thesis_epub: default
...
# This chunk ensures that the lmustatdown package is
# installed and loaded. This lmustatdown package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {lmustatdown}`) {
...
if (!require(lmustatdown)) {
  if (params$`Install needed packages for {lmustatdown}`) {
    remotes::install_github("ismayc/lmustatdown")
  } else {
    stop(
      paste(
        "You need to run",
